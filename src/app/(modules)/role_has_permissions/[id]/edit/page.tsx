...
export default async function RoleHasPermissionEditPage({
  params,
}: {
  params: { id: string };
}) {
      ...
      <form action={editRoleHasPermission} className="px-2 max-w-xl">
        <div>
          <Select
            ...
            defaultValue={{
              label: roleHasPermission.role?.id,
              value: roleHasPermission.role?.id,
            }}
            required
        ...
        <div>
          <Select
            ...
            defaultValue={{
              label: roleHasPermission.permission?.id,
              value: roleHasPermission.permission?.id,
            }}
            required
