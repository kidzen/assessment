...
UserHasRole: true
    ...
    <Select
      ...
      defaultValue={role.RoleHasPermission.map((RoleHasPermission) => ({ label: RoleHasPermission.id, value: RoleHasPermission.id}))}
    ...
    <Select
      ...
      defaultValue={role.UserHasRole.map((UserHasRole) => ({ label: UserHasRole.id, value: UserHasRole.id}))}
