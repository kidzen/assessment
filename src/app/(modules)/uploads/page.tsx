  ...
  return (
    <>
      ...
      <header className="flex justify-between mb-4">
        ...
        <Button as="a" href="/uploads/create" className="font-medium">
          New Upload
        </Button>
      </header>
      ...
      <section className="overflow-x-auto">
        <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
          ...
          <tbody className="divide-y divide-gray-200">
            ...
            {uploads.map((upload) => (
              <tr key={upload.id}>
                <td className="px-4 py-2 text-gray-700">{upload.path}</td>
                <td className="px-4 py-2 text-gray-700">{upload.type}</td>
                <td className="px-4 py-2 text-gray-700">{upload.mime_type}</td>
                <td className="px-4 py-2 text-gray-700">{upload.file_size}</td>
