  ...
  export default async function PasswordResetTokenEditPage({ params }: { params: { id: string } }) {
    ...
    <Input
      ...
      defaultValue={new Date(passwordResetToken.expires).toISOString().slice(0,16)}
      required
