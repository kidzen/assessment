    ...
    return (
      <>
        ...
        <section className="relative overflow-hidden rounded-lg border border-gray-200 p-4 sm:p-6 lg:p-8 max-w-xl mb-4">
          ...
          ></span>
          <p className="text-gray-700 mb-4 last:mb-0"><strong className="text-gray-900">Action:</strong> {permission.action}</p><p className="text-gray-700 mb-4 last:mb-0"><strong className="text-gray-900">Subject:</strong> {permission.subject}</p>
        </section>
