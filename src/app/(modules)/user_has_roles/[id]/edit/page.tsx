  ...
  export default async function UserHasRoleEditPage({ params }: { params: { id: string } }) {
...
user: true
    ...
    <Select
      ...
      defaultValue={{ label: userHasRole.role?.id, value: userHasRole.role?.id }}
      required
    ...
    <Select
      ...
      defaultValue={{ label: userHasRole.user?.id, value: userHasRole.user?.id }}
      required
