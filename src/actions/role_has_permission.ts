...
permission: formData.get('permission') != '' ? { connect: { id: formData.get('permission') as string } } : {},
...
permission: formData.get('permission') != '' ? { connect: { id: formData.get('permission') as string } } : { disconnect: true },
