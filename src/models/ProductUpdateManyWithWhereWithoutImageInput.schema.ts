...
const Schema: z.ZodType<Prisma.ProductUpdateManyWithWhereWithoutImageInput> = z
  .object({
...
export const ProductUpdateManyWithWhereWithoutImageInputObjectSchema = Schema;
