...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutImageInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutImageInputObjectSchema =
  Schema;
