...
const Schema: z.ZodType<Prisma.RoleHasPermissionCreateNestedManyWithoutPermissionInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleHasPermissionCreateNestedManyWithoutPermissionInputObjectSchema =
  Schema;
