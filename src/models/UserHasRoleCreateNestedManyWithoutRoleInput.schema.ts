...
const Schema: z.ZodType<Prisma.UserHasRoleCreateNestedManyWithoutRoleInput> = z
  .object({
    create: z
      .union([
...
export const UserHasRoleCreateNestedManyWithoutRoleInputObjectSchema = Schema;
