...
const Schema: z.ZodType<Prisma.UserHasRoleCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
...
export const UserHasRoleCreateNestedManyWithoutUserInputObjectSchema = Schema;
