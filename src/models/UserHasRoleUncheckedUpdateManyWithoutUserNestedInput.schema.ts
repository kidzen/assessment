...
const Schema: z.ZodType<Prisma.UserHasRoleUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UserHasRoleUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
