...
const Schema: z.ZodType<Prisma.UserHasRoleUpdateManyWithoutRoleNestedInput> = z
  .object({
    create: z
      .union([
...
export const UserHasRoleUpdateManyWithoutRoleNestedInputObjectSchema = Schema;
