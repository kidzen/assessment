...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutImageNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ProductUpsertWithWhereUniqueWithoutImageInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductUpsertWithWhereUniqueWithoutImageInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ProductUpdateWithWhereUniqueWithoutImageInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductUpdateWithWhereUniqueWithoutImageInputObjectSchema,
...
export const ProductUncheckedUpdateManyWithoutImageNestedInputObjectSchema =
  Schema;
