...
const Schema: z.ZodType<Prisma.RoleHasPermissionUncheckedUpdateManyWithoutRoleNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleHasPermissionUncheckedUpdateManyWithoutRoleNestedInputObjectSchema =
  Schema;
