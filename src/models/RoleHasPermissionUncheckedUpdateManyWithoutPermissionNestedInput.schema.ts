...
const Schema: z.ZodType<Prisma.RoleHasPermissionUncheckedUpdateManyWithoutPermissionNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleHasPermissionUncheckedUpdateManyWithoutPermissionNestedInputObjectSchema =
  Schema;
