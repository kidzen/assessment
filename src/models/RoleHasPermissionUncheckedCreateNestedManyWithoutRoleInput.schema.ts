...
const Schema: z.ZodType<Prisma.RoleHasPermissionUncheckedCreateNestedManyWithoutRoleInput> =
  z
    .object({
      create: z
        .union([
...
export const RoleHasPermissionUncheckedCreateNestedManyWithoutRoleInputObjectSchema =
  Schema;
